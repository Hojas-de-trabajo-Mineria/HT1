...
```{r}
print(as.data.frame(table(movies$genres)), row.names = FALSE)
# library(stringr)
# genre = c('Action')
# freq = c(1)
...
print(as.data.frame(table(movies$productionCompany)), row.names = FALSE)
# library(stringi)
# 
...
#### Frecuencia de video
```{r}
print(as.data.frame(table(movies$video)), row.names = FALSE)
```
...
#### Frecuencia de actorsCharacter
```{r}
print(as.data.frame(table(movies$actorsCharacter)), row.names = FALSE)
```

#### Frecuencia de originalTitle
```{r}
print(as.data.frame(table(movies$originalTitle)), row.names = FALSE)
```

#### Frecuencia de title
```{r}
print(as.data.frame(table(movies$title)), row.names = FALSE)
```
...
barplot(generos)
```
El género principal de las 20 películas más recientes es drama.
...
```{r}
plot(movies$castWomenAmount/movies$castMenAmount, movies$popularity)
```


```{r}
plot(movies$castWomenAmount/movies$castMenAmount, movies$revenue)
```
